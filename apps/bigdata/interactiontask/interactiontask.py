...
class InteractionTaskTool(object):
    def __init__(self, namespace='default', interactiontasklog='interaction-task-pv-log' ,nfsinfo={},
        ...
        self.AppInfo['InteractionTaskLogPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, interactiontasklog]))
    ...
    def setupNFS(self):
        ...
        print ('create InteractionTask NFS successfully')


        self.NFSObj.createSubFolder(self.AppInfo['InteractionTaskLogPath'])

        print ('setup InteractionTask NFS successfully')
