...
class DicttoolTool(object):
    def __init__(self, namespace='default', dicttooldata='dicttool-pv-log' ,nfsinfo={},
        ...
        self.AppInfo['DicttoolLogPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, dicttooldata]))
