...
class PictureCenterTool(object):
    def __init__(self, namespace='default', picturecenterlog='picturecenter-pv-log' , picturecenterdata='picturecenter-pv-data', nfsinfo={},
        ...
        self.AppInfo['PictureCenterLogPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, picturecenterlog]))
        self.AppInfo['PictureCenterDataPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, picturecenterdata]))
