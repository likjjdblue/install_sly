...
class MediaResourceTool(object):
    def __init__(self, namespace='default', mediaresourcelog='media-resource-pv-log' , mediaresourcedata='media-resource-pv-data',
        ...
        self.AppInfo['MediaResourceLogPath'] = os.path.join(self.AppInfo['LogStorageBasePath'], '-'.join([namespace, mediaresourcelog]))
        self.AppInfo['MediaResourceDataPath'] = os.path.join(self.AppInfo['DataStorageBasePath'], '-'.join([namespace, mediaresourcedata]))
    ...
    def setupStorage(self):
        ...
        print ('create MediaResource Storage successfully')


        self.LogStorageObj.createSubFolder(self.AppInfo['MediaResourceLogPath'])
        self.DataStorageObj.createSubFolder(self.AppInfo['MediaResourceDataPath'])


        self.TmpStoragePathDict = dict()
        self.TmpStoragePathDict['MediaResourceDataPath'] = self.DataStorageObj.generateRealPath(self.AppInfo['MediaResourceDataPath'])
        self.TmpStoragePathDict['MediaResourceLogPath'] = self.LogStorageObj.generateRealPath(self.AppInfo['MediaResourceLogPath'])

        print ('setup MediaResource Storage successfully')
    ...
    def applyYAML(self):
        ...
        for itime in range(self.RetryTimes):
            ...
            TmpCheckResult = TmpServiceCheckObj.checkServicePortState(targetaddress='media-resource-svc:52618')
            print ('media-resource-svc:52618 is listening....')
    ...
    def postInstall(self):
        ...
        self.DataStorageObj.uploadFile(localpath=os.path.join(self.BaseDIRPath, 'downloads', 'mediaresource.conf'),
