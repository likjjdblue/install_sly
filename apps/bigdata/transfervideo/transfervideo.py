...
class TransferVideoTool(object):
    def __init__(self, namespace='default', transfervideolog='transfer-video-pv-log' ,  nfsinfo={},
        ...
        self.AppInfo['TransferVideoLogPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, transfervideolog]))
    ...
    def applyYAML(self):
        ...
        print ('Waitting TransferVideo for running....')
        sleep(120)
    ...
    def postInstall(self):
        ...
        self.SSHClient.uploadFile(localpath=os.path.join(self.BaseDIRPath, 'downloads', 'transfervideo.conf'),
