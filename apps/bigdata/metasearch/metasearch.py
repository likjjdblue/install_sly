...
class MetaSearchTool(object):
    def __init__(self, namespace='default', metasearchlog='metasearch-pv-log' ,  nfsinfo={},
        ...
        self.AppInfo['MetaSearchLogPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, metasearchlog]))
