...
class TransferResourceAITool(object):
    def __init__(self, namespace='default', transferresourceailog='transfer-resource-ai-pv-log' ,  nfsinfo={},
        ...
        self.AppInfo['TransferResourceAILogPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, transferresourceailog]))
    ...
    def PreInstall(self):
        ...
        '''
        self.SSHClient.uploadFile(localpath=os.path.join(self.BaseDIRPath, 'downloads', 'tmy_decision_center.sql'),
    ...
    def postInstall(self):
        ...
        self.SSHClient.uploadFile(localpath=os.path.join(self.BaseDIRPath, 'downloads', 'transferresourceai.conf'),
