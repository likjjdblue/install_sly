...
class PropagationServerTool(object):
    def __init__(self, namespace='default', propagationserverlog='propagation-server-pv-log',  nfsinfo={},
        ...
        self.AppInfo['PropagationServerLogPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, propagationserverlog]))
    ...
    def PreInstall(self):
        ...
        self.SSHClient.uploadFile(localpath=os.path.join(self.BaseDIRPath, 'downloads', 'propagation.sql'),
    ...
    def postInstall(self):
        ...
        '''
        self.SSHClient.uploadFile(localpath=os.path.join(self.BaseDIRPath, 'downloads', 'piccenter.conf'),
