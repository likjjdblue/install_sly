...
class TimingSchedulerTool(object):
    def __init__(self, namespace='default', timingschedulerlog='timing-scheduler-pv-log' ,  nfsinfo={},
        ...
        self.AppInfo['TimingSchedulerLogPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, timingschedulerlog]))
    ...
    def PreInstall(self):
        ...
        self.SSHClient.uploadFile(localpath=os.path.join(self.BaseDIRPath, 'downloads', 'timing.sql'),
    ...
    def postInstall(self):
        ...
        self.SSHClient.uploadFile(localpath=os.path.join(self.BaseDIRPath, 'downloads', 'timingscheduler.conf'),
