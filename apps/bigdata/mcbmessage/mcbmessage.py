...
class MCBMessageTool(object):
    def __init__(self, namespace='default', mcbmessagelog='mcb-message-pv-log' , mcbmessagedata='mcb-message-pv-data', nfsinfo={},
        ...
        self.AppInfo['MCBMessageLogPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, mcbmessagelog]))
        self.AppInfo['MCBMessageDataPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, mcbmessagedata]))
    ...
    def applyYAML(self):
        ...
        print ('Waitting MCBMessage for running....')
        sleep(120)
    ...
    def postInstall(self):
        ...
        self.SSHClient.uploadFile(localpath=os.path.join(self.BaseDIRPath, 'downloads', 'mcbmessage.conf'),
