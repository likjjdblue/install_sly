...
class ResourceTool(object):
    def __init__(self, namespace='default', resourcelog='resource-pv-log' , resourcedata='resource-pv-data',
        ...
        self.AppInfo['ResourceLogPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, resourcelog]))
        self.AppInfo['ResourceDataPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, resourcedata]))
        self.AppInfo['ResourceMediaDataPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, resourcemediadata]))
    ...
    def postInstall(self):
        ...
        self.SSHClient.uploadFile(localpath=os.path.join(self.BaseDIRPath, 'downloads', 'resource.conf'),
