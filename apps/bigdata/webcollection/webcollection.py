...
class WebCollectionTool(object):
    def __init__(self, namespace='default', webcollectionlog='webcollection-pv-log',  nfsinfo={},
        ...
        self.AppInfo['WebCollectionLogPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, webcollectionlog]))
    ...
    def PreInstall(self):
        ...
        self.SSHClient.uploadFile(localpath=os.path.join(self.BaseDIRPath, 'downloads', 'websitecollection.sql'),
    ...
    def postInstall(self):
        ...
        self.SSHClient.uploadFile(localpath=os.path.join(self.BaseDIRPath, 'downloads', 'webcollection.conf'),
