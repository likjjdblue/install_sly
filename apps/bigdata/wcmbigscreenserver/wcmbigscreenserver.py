...
class WCMBigScreenServerTool(object):
    def __init__(self, namespace='default', wcmbigscreenserverdata='wcm-bigscreen-server-pv-data', nfsinfo={},
        ...
        self.AppInfo['WCMBigScreenServerDataPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, wcmbigscreenserverdata]))
    ...
    def setupNFS(self):
        ...
        print ('create WCMBigScreenServer NFS successfully')


        self.NFSObj.createSubFolder(self.AppInfo['WCMBigScreenServerDataPath'])

        print ('setup WCMBigScreenServer NFS successfully')
    ...
    def postInstall(self):
        ...
        self.SSHClient.uploadFile(localpath=os.path.join(self.BaseDIRPath, 'downloads', 'wcmbigscreenserver.conf'),
