...
class TmyDecisionCenterTool(object):
    def __init__(self, namespace='default', tmydecisioncenterlog='tmy-decision-center-pv-log',
        ...
        self.AppInfo['TmyDecisionCenterLogPath'] = os.path.join(self.AppInfo['LogStorageBasePath'], '-'.join([namespace, tmydecisioncenterlog]))
    ...
    def setupStorage(self):
        ...
        print ('create TmyDecisionCenter Storage successfully')
