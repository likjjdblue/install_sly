...
class iFuncTool(object):
    def __init__(self, namespace='default', ifunclog='ifunc-pv-log' ,  nfsinfo={},
        ...
        self.AppInfo['iFuncLogPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, ifunclog]))
    ...
    def setupNFS(self):
        ...
        print ('create iFunc NFS successfully')


        self.NFSObj.createSubFolder(self.AppInfo['iFuncLogPath'])

        print ('setup iFunc NFS successfully')
