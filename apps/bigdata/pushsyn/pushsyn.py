...
class PushSynTool(object):
    def __init__(self, namespace='default', pushsynlog='push-syn-pv-log',  nfsinfo={},
        ...
        self.AppInfo['PushSynLogPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, pushsynlog]))
