...
class MediaGatewayTool(object):
    def __init__(self, namespace='default', mediagatewayklog='media-gateway-pv-log' ,
        ...
        self.AppInfo['MediaGatewayLogPath'] = os.path.join(self.AppInfo['LogStorageBasePath'], '-'.join([namespace, mediagatewayklog]))
    ...
    def setupStorage(self):
        ...
        print ('create MediaGateway Storage successfully')


        self.LogStorageObj.createSubFolder(self.AppInfo['MediaGatewayLogPath'])

        self.TmpStoragePathDict = dict()
        self.TmpStoragePathDict['MediaGatewayLogPath'] = self.LogStorageObj.generateRealPath(self.AppInfo['MediaGatewayLogPath'])


        print ('setup MediaGateway Storage successfully')
    ...
    def postInstall(self):
        ...
        self.DataStorageObj.uploadFile(localpath=os.path.join(self.BaseDIRPath, 'downloads', 'mediagateway.conf'),
