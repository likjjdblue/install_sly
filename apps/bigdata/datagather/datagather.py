...
class DataGatherTool(object):
    def __init__(self, namespace='default', datagatherlog='gather-consumer-pv-log' , datagatherdata='gather-consumer-pv-data' ,
        ...
        self.AppInfo['DataGatherLogPath'] = os.path.join(self.AppInfo['LogStorageBasePath'], '-'.join([namespace, datagatherlog]))
        self.AppInfo['DataGatherDataPath'] = os.path.join(self.AppInfo['DataStorageBasePath'], '-'.join([namespace, datagatherdata]))
    ...
    def setupStorage(self):
        ...
        print ('create DataGather Storage successfully')
