...
class ScreenDataAccessTool(object):
    ...
    def setupStorage(self):
        ...
        print ('create ScreenDataAccess Storage successfully')


        self.DataStorageObj.createSubFolder(self.AppInfo['ScreenDataAccessDataPath'])

        self.TmpStoragePathDict = dict()
        self.TmpStoragePathDict['ScreenDataAccessDataPath'] = self.DataStorageObj.generateRealPath(self.AppInfo['ScreenDataAccessDataPath'])

        print ('setup ScreenDataAccess Storage successfully')
    ...
    def applyYAML(self):
        ...
        for itime in range(self.RetryTimes):
            ...
            TmpCheckResult = TmpServiceCheckObj.checkServicePortState(targetaddress='screen-data-access-svc:9995')
            print ('screen-data-access-svc:9995 is listening....')
    ...
    def postInstall(self):
        ...
        '''
        self.DataStorageObj.uploadFile(localpath=os.path.join(self.BaseDIRPath, 'downloads', 'screendataaccess.conf'),
