...
class BigdataAccessTool(object):
    def __init__(self, namespace='default', bigdataaccesslog='bigdata-access-pv-log',
        ...
        self.AppInfo['BigdataAccessLogPath'] = os.path.join(self.AppInfo['LogStorageBasePath'], '-'.join([namespace, bigdataaccesslog]))
    ...
    def setupStorage(self):
        ...
        print ('create BigdataAccess Storage successfully')
