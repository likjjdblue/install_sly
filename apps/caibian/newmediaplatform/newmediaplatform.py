...
class NewMediaPlatformTool(object):
    def __init__(self, namespace='default', newmediaplatformlogpath='newmediaplatform-pv-log', newmediaplatformdatapath='newmediaplatform-pv-data',
        ...
        self.AppInfo['NewMediaPlatformLogPath'] = os.path.join(self.AppInfo['DataStorageBasePath'], '-'.join([namespace, newmediaplatformlogpath]))
        self.AppInfo['NewMediaPlatformDataPath'] = os.path.join(self.AppInfo['LogStorageBasePath'], '-'.join([namespace, newmediaplatformdatapath]))
    ...
    def setupStorage(self):
        ...
        print ('create NewMediaPlatform Storage successfully')
