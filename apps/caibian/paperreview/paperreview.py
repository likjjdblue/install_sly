...
class PaperReviewTool(object):
    def __init__(self, namespace='default', paperreviewlogdata='paperreview-pv-log' ,nfsinfo={},
        ...
        self.AppInfo['PaperReviewLogPath'] = os.path.join(self.AppInfo['NFSBasePath'], '-'.join([namespace, paperreviewlogdata]))
    ...
    def applyYAML(self):
        ...
        print ('Waitting PaperReview for running....')
        sleep(120)
