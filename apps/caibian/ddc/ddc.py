...
class DDCTool(object):
    def __init__(self, namespace='default', ddclogdata='ddc-pv-log',
        ...
        self.AppInfo['DDCLogPath'] = os.path.join(self.AppInfo['LogStorageBasePath'], '-'.join([namespace, ddclogdata]))
    ...
    def setupStorage(self):
        ...
        print ('create DDC Storage successfully')

        self.LogStorageObj.createSubFolder(self.AppInfo['DDCLogPath'])

        self.TmpStoragePathDict = dict()
        self.TmpStoragePathDict['DDCLogPath'] = self.LogStorageObj.generateRealPath(self.AppInfo['DDCLogPath'])

        print ('setup DDC Stoarge successfully')
    ...
    def postInstall(self):
        ...
        self.DataStorageObj.uploadFile(localpath=os.path.join(self.BaseDIRPath, 'downloads', 'ddc.conf'),
