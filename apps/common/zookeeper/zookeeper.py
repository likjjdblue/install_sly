...
class ZookeeperTool(object):
    ...
    def __init__(self, namespace='default', zookeeperdatapath='nfs-provisioner',harbor=None, retrytimes=60):
        ...
        self.AppInfo['ZookeeperDataPath'] = os.path.join(self.AppInfo['DataStorageBasePath'], '-'.join([namespace, zookeeperdatapath]))
    ...
    def setupStorage(self):
        ...
        print ('create Zookeeper Storage successfully')
        self.DataStorageObj.createSubFolder(self.AppInfo['ZookeeperDataPath'])
    ...
    def applyYAML(self):
        ...
        for itime in range(self.RetryTimes):
            ...
            TmpServiceCheckObj = servicestatecheck.ServiceStateCheckTool(namespace=self.AppInfo['Namespace'],
                                                                         harbor=self.AppInfo['HarborAddr'])
            TmpCheckResult = TmpServiceCheckObj.checkServicePortState(targetaddress='zookeeper-svc:2181')
